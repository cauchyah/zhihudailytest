...
constructor(activity: Activity) {
    ...
    init {
        ...
        config = SystemBarConfig(activity, mStatusBarAvailable,
                mNavBarAvailable)
    ...
    private fun setupNavBarView(context: Context, decorViewGroup: ViewGroup) {
        ...
        if (config!!.isNavigationAtBottom) {
            ...
            params = LayoutParams(config!!.navigationBarWidth,
     ...
     *
     */
   internal class SystemBarConfig (activity: Activity,
                                              private val mTranslucentStatusBar: Boolean, private val mTranslucentNavBar: Boolean) {
        /**
        ...
        private fun hasNavBar(context: Context): Boolean {
            val res = context.resources
            val resourceId = res.getIdentifier(SHOW_NAV_BAR_RES_NAME, "bool",
                    "android")
            if (resourceId != 0) {
